...
void FacoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About FaCoin"), this);
...
void FacoinGUI::setNumBlocks(int count)
{
...
void FacoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("FaCoin") + " - ";
...
void FacoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(FacoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
