 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the Facoin library.
 *
...
public:
	 ...
	 * @throw      Facoin exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		Facoin exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A FacoinException if the accumulator value is invalid.
	//  */
