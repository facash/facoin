 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the Facoin library.
 *
...
/** The complete proof needed to spend a facoin.
...
public:
	...
	/**Generates a proof spending a facoin.
	 *
	 * To use this, provide an unspent PrivateCoin, the latest Accumulator
	 * (e.g from the most recent Facoin block) containing the public part
	 ...
	 * @param m arbitrary meta data related to the spend that might be needed by Facoin
	 * 			(i.e. the transaction hash)
	 * @throw FacoinException if the process fails
	 */
