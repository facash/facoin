...
#ifndef H_FACOIN_SCRIPT
#define H_FACOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CFacoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Facoin always counted CHECKMULTISIGs
